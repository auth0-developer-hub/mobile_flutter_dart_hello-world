            ...
            ListTile(
                title: Text(
                  ...
                  style: TextStyle(
                      ...
                      decorationThickness: activePage == 'profile' ? 2 : 0,
            ...
            ListTile(
              title: Text(
                ...
                style: TextStyle(
                    ...
                    decoration: TextDecoration.underline,
                    decorationStyle: TextDecorationStyle.solid,
                    decorationThickness: activePage == 'public' ? 2 : 0,
                    decorationColor: const Color(0xff413DA6)),
              ),
              onTap: () {
                Navigator.pop(context);
            ...
            ListTile(
              title: Text(
                ...
                style: TextStyle(
                    ...
                    decoration: TextDecoration.underline,
                    decorationStyle: TextDecorationStyle.solid,
                    decorationThickness: activePage == 'protected' ? 2 : 0,
                    decorationColor: const Color(0xff413DA6)),
              ),
              onTap: () {
                Navigator.pop(context);
            ...
            ListTile(
              title: Text(
                ...
                style: TextStyle(
                    ...
                    decoration: TextDecoration.underline,
                    decorationStyle: TextDecorationStyle.solid,
                    decorationThickness: activePage == 'admin' ? 2 : 0,
                    decorationColor: const Color(0xff413DA6)),
              ),
              shape: const Border(
